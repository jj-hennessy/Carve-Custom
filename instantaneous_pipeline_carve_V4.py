...
all_going_well = True
survey_id = 'SV_bpXudYLJb6J8NdI'
send_email_a = True
csv_with_records = 'record_responses_study_v4.csv'

while all_going_well:
    survey_df = get_qualtrics_data(survey_id, 'qualtrics_resp_v4', 'qualtrics_resp_v4/Trust Carve_v4.csv')
